...
import net.afandistudio.aplikasikpu.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng tps = new LatLng(-7.836779821601592, 110.3744341147726);
        mMap.addMarker(new MarkerOptions().position(tps).title("TPS Kominfo"));
