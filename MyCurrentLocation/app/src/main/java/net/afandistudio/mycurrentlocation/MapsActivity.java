...
import net.afandistudio.mycurrentlocation.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(-7.836516, 110.374409);
        mMap.addMarker(new MarkerOptions().position(sydney).title("TPS BPSDMP Kominfo"));
