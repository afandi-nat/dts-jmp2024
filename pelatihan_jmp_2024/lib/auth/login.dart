...
import 'package:pelatihan_jmp_2024/home_page.dart';
import 'package:pelatihan_jmp_2024/auth/register_page.dart';
...
class LoginPage extends StatelessWidget {
  ...
  login(BuildContext context) async {
    String url = 'http://192.168.1.6/pelatihan_jmp/user/login.php';
